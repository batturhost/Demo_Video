...
// --- NEW: GOLDEN OVERRIDE ---
// If this was triggered by the glitch event, rename the file and species
if (variable_global_exists("is_golden_event") && global.is_golden_event) {
    species_name = "Golden Snub-Nosed Monkey";
    filename = "GOLD_MONKEY.EXE";
}
